...
def get_filters():
    ...
    while True:
        city = input(
            'Which of the following you would like to see data for Chicago,New York, or Washington?').lower()
        if city not in (CITY_DATA.keys()):
            print("Yourinput should be either: Chicago, New York, or Washington?")
            continue
        else:
            break
    ...
    while True:
        month = input(
            'Specify the month - January, February, March, April, May, June, or all?').lower()
        if month not in ('january', 'february', 'march', 'april', 'may', 'june', 'all'):
            print(
                "Your input should be either: January, February, March, April, May, June, or all")
            continue
        else:
            break
    ...
    while True:
        ...
        day = input(
            'Specify the day - Monday, Tuesday, Wednesday, Thursday, Friday, Saturday, Sunday, or all?').lower()
        if day not in ('monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday', 'sunday', 'all'):
            print(
                "Yourinput should be either: Monday, Tuesday, Wednesday, Thursday, Friday, Saturday, Sunday, or all")
            continue
        else:
            break
